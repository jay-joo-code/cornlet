...
const SoldComponent = () => (
  <FlexColumn alignCenter>
    <Btn background={theme.grey[300]} fullWidth inverted disabled>
      Message host
    </Btn>
    <Space margin='.3rem 0' />
    <Body colorHex={theme.textMuted} fontSize='.8rem'>
  ...
  <div>
    ...
    <FlexColumn alignCenter>
      ...
      <FlexRow justifyCenter style={{ width: '90%' }}>
        <Body colorHex={theme.textMuted} fontSize='.8rem' style={{ textAlign: 'center' }}>
          ...
          <>
            ...
            (cornellOnly && signedInUser && signedInUser.email.split('@')[1] === 'cornell.edu') ? (
              <div>
                ...
                <Btn color='primary' fullWidth inverted onClick={handleMsgBtnClick}>
                  Message host
                </Btn>
              </div>
            ) : (
